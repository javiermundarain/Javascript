...
const ficha1 = new Ficha ("Poción de amor", "./js/contenido/amor.png", "Sirve para induc...", "Sirve para inducir amor infinito a la persona que la consuma", "80$")
const ficha2 = new Ficha ("Poción de clarividencia", "./js/contenido/clarividencia.png", "Sirve para pre...", "Sirve para predecir el futuro por una semana", "150$")
const ficha3 = new Ficha ("Poción de Muerte instantanea", "./js/contenido/muerte.png", "Induce la muerte de una ...", "Induce la muerte de una forma discreta y sin dejar evidencia; Nota: nuestro pocion de resurrecion sirve si se aplica esta poción", "500$")
const ficha4 = new Ficha ("Poción de Resurreción", "./js/contenido/resurrecion.png", "Regresa de la ...", "Regresa de la muerte a cualquier persona despues de morir; Nota: maximo 3 dias para inducir desde la muerte del individuo", "900$")
                            //creacion de constructor
